...
public class UserHistoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            OrderLineDAO orDAO = new OrderLineDAO();
            RentalHistoryDAO history = new RentalHistoryDAO();
            ...
            listHistory = history.getHistory(nameLogin);

            List<OrderLineDTO> listDAO = new ArrayList<>();
            listDAO = orDAO.checkRental(currentDate);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UserHistoryServlet.class.getName()).log(Level.SEVERE, null, ex);
