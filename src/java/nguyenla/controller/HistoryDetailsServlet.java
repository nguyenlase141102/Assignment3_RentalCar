...
public class HistoryDetailsServlet extends HttpServlet {
     ...
     */
    private final String SUCCESS = "HistoryDetails.jsp";
    private String url;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int orIdInt = Integer.parseInt(orID);
            OrderLineDAO orlDAO = new OrderLineDAO();
            List<OrderLineDTO> listDetails = new ArrayList<>();

            listDetails = orlDAO.getCarByOrder(orIdInt);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(HistoryDetailsServlet.class.getName()).log(Level.SEVERE, null, ex);
